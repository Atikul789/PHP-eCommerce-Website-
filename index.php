...
$all_post_query = mysqli_query($con,"SELECT * FROM `tbl_post` WHERE stutas = 'Public'");
    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="row">
                <div class="col-sm-12 ">
                        <?php
                                $sql = "SELECT * FROM `tbl_post` WHERE stutas = 'Public' ORDER BY id DESC LIMIT $post_start_from, $number_of_post";
                        ...
                        ?>
                        <div class="title">
                                <h2><a href="post.php?read_all=<?php echo $id;?>"><?php echo $title;?></a></h2>
                                <p><?php echo $date;?></p>
