...
if(isset($_GET['cat'])){
$catName = $_GET['cat'];
$all_post_query = mysqli_query($con,"SELECT * FROM `tbl_post` WHERE stutas = 'Public' and category = '$catName'");
        ...
        <div class="col-sm-8">
            <div class="row">
                <div class="col-sm-12 ">
                        ...
                        if(isset($_GET['cat'])){
                            $catName = $_GET['cat'];
                                $sql = "SELECT * FROM `tbl_post` WHERE stutas = 'Public' and category = '$catName' ORDER BY id DESC";
                ...
                <div class="post-content">
                   ...
                   <?php } }else {
                       echo "<center class='alert alert-danger'>This Category have No item!!</center>";
                   } }?>
                </div>
            </div>
            <hr>
